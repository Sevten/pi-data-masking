...
- Rule Builder structured form: new "Keep prefix" selector (Off / First segment / First N chars) controlling `preserveStructure.keepPrefix`; regex and auto-placeholder literal rules only.
